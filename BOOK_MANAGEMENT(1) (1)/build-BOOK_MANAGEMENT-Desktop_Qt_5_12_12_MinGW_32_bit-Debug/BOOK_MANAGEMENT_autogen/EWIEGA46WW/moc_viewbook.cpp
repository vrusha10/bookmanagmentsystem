...
#include "../../../BOOK_MANAGEMENT/viewbook.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ViewBook_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ViewBook_t qt_meta_stringdata_ViewBook = {
    {
QT_MOC_LITERAL(0, 0, 8), // "ViewBook"
QT_MOC_LITERAL(1, 9, 11), // "ReceiveData"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 17), // "QMap<QString,int>"
QT_MOC_LITERAL(4, 40, 12) // "ReceiveData1"

    },
    "ViewBook\0ReceiveData\0\0QMap<QString,int>\0"
    "ReceiveData1"
};
...
void ViewBook::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ReceiveData((*reinterpret_cast< QMap<QString,int>(*)>(_a[1]))); break;
        case 1: _t->ReceiveData1((*reinterpret_cast< QMap<QString,int>(*)>(_a[1]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject ViewBook::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_ViewBook.data,
