...
public:
    ...
    void setupUi(QDialog *AddBook)
    {
        ...
        layoutWidget->setGeometry(QRect(80, 100, 231, 91));
    ...
    void retranslateUi(QDialog *AddBook)
    {
        ...
        label_2->setText(QApplication::translate("AddBook", "quantity", nullptr));
        pushButton_2->setText(QApplication::translate("AddBook", "add ", nullptr));
    } // retranslateUi
